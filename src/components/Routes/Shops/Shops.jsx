                ...
                <Card variant="outlined" key={entry["created_at"]}>
                  <CardContent>
                    <Typography variant="p">
                      <StoreIcon /> {"Name: " + capitalize(entry.name)}
                    </Typography>{" "}
                    <br />
                    <Typography variant="p">
                      <NotesIcon />{" "}
                      {"Description: " + capitalize(entry.description)}
                    </Typography>{" "}
                    <br />
                    <Typography variant="p">
                      <ShoppingCartIcon /> {"Type: " + capitalize(entry.type)}
                    </Typography>{" "}
                    <br />
                    <Typography variant="p">
                      {" "}
                      {entry.address.includes("www.") ? (
                        <>
                          <LanguageIcon />{" "}
                          <Link
                            href={`http://${entry.address}`}
                            target="_blank"
                          >
                            {entry.address}
                          </Link>
                        ...
                        <>
                          <BusinessIcon /> {capitalize(entry.address)}
                        </>
                      )}{" "}
                    </Typography>{" "}
                    <br />
                    <Typography variant="p">
                      <ScheduleIcon />{" "}
                      {"Schedule: " + capitalize(entry.schedule)}
                    </Typography>{" "}
                    <br />
                    <Typography variant="p">
                      <CalendarTodayIcon />{" "}
